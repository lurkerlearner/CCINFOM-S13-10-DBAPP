...
public class Ingredient {
    ...
    public Ingredient(int batch_no, String ingredient_name,
                      Category category, Storage_type storage_type, Measurement_unit measurement_unit,
                      double stock_quantity, Date expiry_date)
    {
        this.ingredient_id = -1; // temp value since autoincremented value sha sa database
        ...
        this.restock_status = Restock_status.calculateStatus(stock_quantity);
        this.supplier_id = -1; // temp value since autoincremented value sha sa database
    }

    // Full constructor for retrieving existing ingredients from database
    public Ingredient(int ingredient_id, int batch_no, String ingredient_name,
                      Category category, Storage_type storage_type,
                      Measurement_unit measurement_unit, double stock_quantity,
                      Date expiry_date, Restock_status restock_status, int supplier_id) {
