...
public class DeliveryDAO 
{
     ...
     * Sales Report: Faith
     * 
     * Generates a sales report given the month and year.
     * Shows the number of meals sold/meaning successfully ordered
    ...
    public ArrayList<SalesReport> generateSalesReport(int year, int month) {
        ...
        String sqlQuery = """
                ...
                WHERE d.delivery_status <> 'Cancelled' AND d.payment_status = 'Paid'
                    AND YEAR(d.order_date) = ? AND MONTH(d.order_date) = ?
